                    ...
                    <div class="card-body">
                        <form method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="<?php echo htmlspecialchars($employee['employee_code']); ?>" readonly class="readonly">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="<?php echo htmlspecialchars($employee['department']); ?>" readonly class="readonly">
                            </div>
                            
                            <div class="form-group">
                                <label>Position</label>
                                <input type="text" value="<?php echo htmlspecialchars($employee['position']); ?>" readonly class="readonly">
                            </div>
